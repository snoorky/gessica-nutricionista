...
$w.onReady(function () {
    ...
    .then(results => {
        ...
        $w("#dataBlog1").text = formatarData(results.items[0].dataPublicacao);
    ...
    .then(results => {
        ...
        $w("#dataBlog2").text = formatarData(results.items[0].dataPublicacao);
    ...
    .then(results => {
        ...
        $w("#dataBlog3").text = formatarData(results.items[0].dataPublicacao);
    ...
    .then(results => {
        ...
        console.error('Erro a ocarregar as avaliações', err)
    });
